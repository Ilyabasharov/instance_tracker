...
from detector.yolact_edge.data.config import cfg, mask_type
from detector.yolact_edge.layers import Detect
from detector.yolact_edge.layers.interpolate import InterpolateModule
from detector.yolact_edge.layers.warp_utils import deform_op
from detector.yolact_edge.backbone import construct_backbone

import torch.backends.cudnn as cudnn
from detector.yolact_edge.utils import timer
from detector.yolact_edge.utils.functions import MovingAverage
...
class Yolact(nn.Module):
    ...
    def __init__(self, training=True):
        ...
        for idx, layer_idx in enumerate(self.selected_layers):
            ...
            pred = PredictionModule(
                in_channels=src_channels[layer_idx],
                out_channels=src_channels[layer_idx],
    ...
    def to_tensorrt_backbone(self, int8_mode=False, calibration_dataset=None, batch_size=1):
        ...
        x = torch.ones(
            size=(1, 3, cfg.max_size, cfg.max_size),
            device='cuda',
        )
